...
$ns duplex-link-op $source1 $receive1 orient right-down
...
proc record {} {
	global sink_1 sink_2 ftp_1 ftp_2 throughput1 throughput2 count
	...
	set throughput1 [expr $throughput2 + $byte_2/$time_set*8/1000000]
...
set trace_file_2 [open "$file--source2.tr" w]
